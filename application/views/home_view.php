    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav">
        ...
        <li><a href="web">About</a></li>
         <li class="active"><a href="<?php echo site_url()?>list_blog">Blog</a></li>
      </ul>
      <ul class="nav navbar-nav navbar-right">
        <li><a href="#"><span class="glyphicon glyphicon-log-in"></span> Login</a></li>
              ...
              <a href="list_blog/add" class="btn btn-primary">Add Artikel</a>   
        ...
        <div class="well well-sm">
          <div class="row">
            <div class="col-sm-12 col-md-12">
              ...
              <a href='<?php echo site_url()?>list_blog/delete/<?php echo $key->id_blog ?>' class='btn btn-sm btn-danger'>Hapus</a>
            </div>
          </div>
        </div>
        <?php endforeach ?>

...
<div class="container">
	...
	<?php    
     ...
     ?> 
      ...
      <?php echo form_open_multipart( 'list_blog/add', array('class' => 'needs-validation', 'novalidate' => '') ); ?>
<center>
      <table>
        <tr>
         ...
         <tr>
          ...
          <td>:</td>
          <td><?php echo form_dropdown('id', $categories, set_value('id'), 'class="form-control" required' ); ?></td>
        </tr>
        <tr>
